...
class EvaluationSampleOutput(BaseModel):
    ...
    Attributes:
        ...
        Topic coverage score indicating how well the response covers the expected topics
        (0.0 to 1.0)
    """
...
class CoverageMetric(Metric):
    ...
    in the evaluation samples. It provides insights into how comprehensively the system
