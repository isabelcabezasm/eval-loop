...
class EvaluationSampleInput(BaseModel):
    ...
    Attributes:
        ...
        information or background data
...
class EvaluationSampleOutput(BaseModel):
    ...
    Attributes:
        ...
        evaluation llm_response (str): The response generated by the language
        model entities (list[str]): List of entities extracted from the
        response accuracy (float): Accuracy score for the evaluation sample
        (0.0 to 1.0) topic_coverage (float): Topic coverage score indicating
        how well the response covers the expected topics (0.0 to 1.0)
    """
